...
def main():
    for seed in range(0, 1000, 100):
        ...
        gpt2_trained_result = Path(__file__).parent.resolve() / f"../results/gpt2_varied_attn_heads_{seed}_result.pkl"
        ...
        for result in results:
            ...
            print(f"Attention Heads: {result.model_config.n_head}", scores, normalized_scores)
