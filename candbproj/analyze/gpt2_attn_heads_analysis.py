...
from candbproj.analyze.analysis import extract_process_normalize, \
    df_by_key, generate_color, dfs_by_layer, layer_fill_axis, key_fill_axis
...
def main():
    ...
    normalized_attn_head_scores = extract_process_normalize(
    ...
    df = df_by_key(final_results, "n_head")

    # Plot this data with a scatterplot
    key_fill_axis(axis[1], df, label="hi")
    plt.show()
